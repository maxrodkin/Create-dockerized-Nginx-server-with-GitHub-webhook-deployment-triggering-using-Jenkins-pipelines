node {
        ...
        sh "docker-machine create --driver amazonec2 --amazonec2-region eu-west-1 --amazonec2-vpc-id vpc-6440e402 --amazonec2-access-key key --amazonec2-secret-key 
Password aws-mr-nginx-lua-6"
